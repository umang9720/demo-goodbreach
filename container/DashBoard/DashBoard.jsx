...
const GoalCard = ({ goal }) => (
  <View style={styles.goalCard}>
    ...
    <Text style={styles.goalTarget}>
      Target: £{goal.goalAmount?.toFixed(2) || "0.00"}
    </Text>
    <Text style={styles.goalStat}>
      Saved: £{goal.savedAmount?.toFixed(2) || "0.00"}
    </Text>
    <Text style={styles.goalStat}>
      Progress:{" "}
      {goal.goalAmount
        ? Math.round((goal.savedAmount / goal.goalAmount) * 100)
        : 0}
      %
    </Text>
      ...
      <View
        style={[
          styles.progressBar,
          {
            width: `${
              goal.goalAmount
                ? Math.min((goal.savedAmount / goal.goalAmount) * 100, 100)
                : 0
            }%`,
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.fullChallengeCard}>
          <View style={styles.challengeContent}>
            ...
            <View style={styles.challengeInfo}>
              <Text style={styles.challengeTitleLarge}>
                Hydration Challenge
              </Text>
              <Text style={styles.challengeDescriptionLarge}>
        ...
        <View style={styles.fullChallengeCard}>
          <View
            style={[styles.challengeIconLarge, { backgroundColor: "#F3E8FF" }]}
          >
            <Text style={styles.challengeEmojiLarge}>📱</Text>
          </View>
          <View style={styles.challengeInfo}>
