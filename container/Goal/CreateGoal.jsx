...
const CreateGoalScreen = () => {
  ...
  const handleCreateGoal = async () => {
    ...
    await api('/create/goal', 'POST', body, user.token);
  };

  return (
    <View style={styles.container}>
      <TextInput placeholder="Goal Name" onChangeText={setGoalName} />
      <TextInput placeholder="Goal Amount" onChangeText={setGoalAmount} keyboardType="numeric" />
      <TextInput placeholder="Goal Image URL" onChangeText={setGoalImage} />
      <TextInput placeholder="Duration Date" onChangeText={setDurationDate} />
      <Button title="Submit" onPress={handleCreateGoal} />
    </View>
  );
};
